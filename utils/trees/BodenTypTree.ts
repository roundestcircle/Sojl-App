...
export const BodenTypTree: DecisionTreeData = {
  id: 'start',
  question: 'Dominierend aus organischen (O-, H-, U- oder W-) Horizonten bestehend?',
  ...
  nodes: {
    ...
    organisch_auflage: {
      ...
      question: 'Mit mächtiger organischer Auflage oder Auflage direkt über dem unveränderten Locker- oder Festgestein?',
    ...
    mineral_grund_ufer: {
      ...
      question: 'Am Grund oder Ufer von Gewässern oder durch Reduktgase dominiert?',
    ...
    mineral_stoffeintraege: {
      ...
      question: 'Mit Stoffeinträgen im Oberboden durch Überflutungswasser, aber ohne hydromorphe Merkmale oberhalb 4 dm unter GOF?',
    ...
    mineral_sauer_bleichung: {
      ...
      question: 'Sauergebleichter Verarmungshorizont und Anreicherungshorizont von Eisenoxiden oder Humusstoffen ausgeprägt?',
    ...
    mineral_tonreich: {
      id: 'mineral_tonreich',
      question: 'Tonreicher Unterboden, durch Lösungsverwitterung aus Kalkgesteinen, aus Tonstein oder tonig verwitterndem Gestein entstanden?',
    ...
    mineral_locker_kolloide: {
      ...
      question: 'Unterboden sehr locker gelagert und mit Kolloiden hoher chemischer Reaktivität?',
    ...
    mineral_tropisch_ja_ast: {
      ...
      question: 'Mit einem durch tropische Verwitterung entstandenen Unterboden?',
    ...
    result_U: {
      id: 'result_U',
      question: 'Klasse U – Subhydrische organische Böden\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
    ...
    typ_OG: {
      id: 'typ_OG',
      question: 'Ergebnis',
      result: { title: 'Typ OG – Organogyttja', description: 'Uo an BOF beginnend.' },
    },
    typ_OS: {
      id: 'typ_OS',
      question: 'Ergebnis',
      result: { title: 'Typ OS – Organosapropel', description: 'Ur an BOF beginnend.' },
    },

    // ── F ──────────────────────────────────────────────────────────
    result_F: {
      id: 'result_F',
      question: 'Klasse F – Organosole\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
        { text: 'O..- und O..+C.. in Summe < 1 dm mächtig', next: 'typ_FP' },
        { text: 'O.. ≥ 3 dm mächtig oder O..- und O..+C in Summe 1–< 3 dm mächtig und über C', next: 'typ_FF' },
      ],
    },
    ...
    typ_FP: {
      id: 'typ_FP',
      question: 'Ergebnis',
      result: { title: 'Typ FP – Protoorganosol', description: 'O..- und O..+C.. in Summe < 1 dm mächtig.' },
    },
    typ_FF: {
      id: 'typ_FF',
      question: 'Ergebnis',
      result: { title: 'Typ FF – Organosol', description: 'O.. ≥ 3 dm mächtig oder O..- und O..+C in Summe 1–< 3 dm mächtig und über C.' },
    },

    // ── H ──────────────────────────────────────────────────────────
    result_H: {
      id: 'result_H',
      question: 'Klasse H – Natürliche und naturnahe Moore\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
        { text: 'hH > 1 dm mächtig und hHw < 1 dm u. TOF beginnend', next: 'typ_HH' },
        { text: 'nH oder uH > 1 dm mächtig und nHw oder uHw < 1 dm u. TOF beginnend', next: 'typ_HN' },
    ...
    typ_HH: {
      id: 'typ_HH',
      question: 'Ergebnis',
      result: { title: 'Typ HH – Hochmoor', description: 'hH > 1 dm mächtig und hHw < 1 dm u. TOF beginnend.' },
    },
    typ_HN: {
      id: 'typ_HN',
      question: 'Ergebnis',
      result: { title: 'Typ HN – Niedermoor', description: 'nH oder uH > 1 dm mächtig und nHw oder uHw < 1 dm u. TOF beginnend.' },
    },
    typ_HW: {
      id: 'typ_HW',
      question: 'Ergebnis',
      result: { title: 'Typ HW – Muddemoor', description: 'Uw oder Ur < 1 dm u. TOF beginnend.' },
    },

    // ── K ──────────────────────────────────────────────────────────
    result_K: {
      id: 'result_K',
      question: 'Klasse K – Erd- und Mulmmoore\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
    ...
    typ_KH: {
      id: 'typ_KH',
      question: 'Ergebnis',
      result: { title: 'Typ KH – Erdhochmoor', description: 'Hv ≥ 1 dm mächtig über hH..' },
    },
    typ_KO: {
      id: 'typ_KO',
      question: 'Ergebnis',
      result: { title: 'Typ KO – Mulmhochmoor', description: 'Hm ≥ 1 dm mächtig über hH..' },
    },
    typ_KV: {
      id: 'typ_KV',
      question: 'Ergebnis',
      result: { title: 'Typ KV – Erdniedermoor', description: 'Hv ≥ 1 dm mächtig über nH.. oder uH..' },
    },
    typ_KM: {
      id: 'typ_KM',
      question: 'Ergebnis',
      result: { title: 'Typ KM – Mulmniedermoor', description: 'Hm ≥ 1 dm mächtig über nH.. oder uH..' },
    },
    typ_KE: {
      id: 'typ_KE',
      question: 'Ergebnis',
      result: { title: 'Typ KE – Erdmuddemoor', description: 'Uv < 1 dm u. TOF beginnend.' },
    },
    typ_KU: {
      id: 'typ_KU',
      question: 'Ergebnis',
      result: { title: 'Typ KU – Mulmmuddemoor', description: 'Um < 1 dm u. TOF beginnend.' },
    },

    // ── M ──────────────────────────────────────────────────────────
    result_M: {
      id: 'result_M',
      question: 'Klasse M – Moorkultisole\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
    ...
    typ_MR: {
      id: 'typ_MR',
      question: 'Ergebnis',
      result: { title: 'Typ MR – Rigomoorkultisol', description: 'Wi oder Wp bis ≥ 4 dm reichend.' },
    },
    typ_MD: {
      id: 'typ_MD',
      question: 'Ergebnis',
      result: { title: 'Typ MD – Depomoorkultisol', description: 'Wt bis ≥ 4 dm reichend.' },
    },

    // ── O ──────────────────────────────────────────────────────────
    result_O: {
      id: 'result_O',
      question: 'Klasse O – Rohböden\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
        { text: 'Ai vorhanden', next: 'typ_OO' },
      ],
    },
    ...
    typ_RN: {
      id: 'typ_RN',
      question: 'Ergebnis',
      result: { title: 'Typ RN – Ranker', description: 'Ah, Ax, Au < 4 dm mächtig über i..C..' },
    },
    typ_RZ: {
      id: 'typ_RZ',
      question: 'Ergebnis',
      result: { title: 'Typ RZ – Pararendzina', description: 'Ah, Ax < 4 dm mächtig über e..C..' },
    },
    typ_RR: {
      id: 'typ_RR',
      question: 'Ergebnis',
      result: { title: 'Typ RR – Rendzina', description: 'Ah, Ax < 4 dm mächtig über c..C..' },
    },
    typ_RT: {
      id: 'typ_RT',
      question: 'Ergebnis',
      result: { title: 'Typ RT – Tschernosem', description: 'Ax bis ≥ 4 dm u. MOF reichend.' },
    },
    typ_RU: {
      id: 'typ_RU',
      question: 'Ergebnis',
      result: { title: 'Typ RU – Umbrisol', description: 'Au bis ≥ 4 dm u. MOF reichend.' },
    },

    // ── D ──────────────────────────────────────────────────────────
    result_D: {
      id: 'result_D',
      question: 'Klasse D – Pelosole\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
        { text: 'Pv < 3 dm u. MOF beginnend', next: 'typ_DD' },
      ],
    },
    ...
    typ_DD: {
      id: 'typ_DD',
      question: 'Ergebnis',
      result: { title: 'Typ DD – Pelosol', description: 'Pv < 3 dm u. MOF beginnend.' },
    },

    // ── N ──────────────────────────────────────────────────────────
    result_N: {
      id: 'result_N',
      question: 'Klasse N – Andosole\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
        { text: 'N..v oder N..v-A.. < 3 dm u. MOF beginnend und bis ≥ 4 dm reichend', next: 'typ_NN' },
      ],
    },
    ...
    typ_NN: {
      id: 'typ_NN',
      question: 'Ergebnis',
      result: { title: 'Typ NN – Andosol', description: 'N..v oder N..v-A.. < 3 dm u. MOF beginnend und bis ≥ 4 dm reichend.' },
    },

    // ── B ──────────────────────────────────────────────────────────
    result_B: {
      id: 'result_B',
      question: 'Klasse B – Braunerden\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
        { text: 'Bv vorhanden', next: 'typ_BB' },
      ],
    },
    ...
    result_C: {
      id: 'result_C',
      question: 'Klasse C – Terrae calcis\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
    ...
    typ_CF: {
      id: 'typ_CF',
      question: 'Ergebnis',
      result: { title: 'Typ CF – Terra fusca', description: 'Tv < 3 dm u. MOF beginnend.' },
    },
    typ_CR: {
      id: 'typ_CR',
      question: 'Ergebnis',
      result: { title: 'Typ CR – Terra rossa', description: 'Tu < 3 dm u. MOF beginnend.' },
    },

    // ── V ──────────────────────────────────────────────────────────
    result_V: {
      id: 'result_V',
      question: 'Klasse V – Ferrallite u. Fersiallite\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
    ...
    result_L: {
      id: 'result_L',
      question: 'Klasse L – Lessivés\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
        { text: 'Kt < 8 dm u. MOF beginnend', next: 'typ_LL' },
        { text: 'Kt < 8 dm u. MOF beginnend und Eal vorhanden', next: 'typ_LF' },
      ],
    },
    ...
    typ_LL: {
      id: 'typ_LL',
      question: 'Ergebnis',
      result: { title: 'Typ LL – Parabraunerde', description: 'Kt < 8 dm u. MOF beginnend.' },
    },
    typ_LF: {
      id: 'typ_LF',
      question: 'Ergebnis',
      result: { title: 'Typ LF – Fahlerde', description: 'Kt < 8 dm u. MOF beginnend und Eal vorhanden.' },
    },

    // ── P ──────────────────────────────────────────────────────────
    result_P: {
      id: 'result_P',
      question: 'Klasse P – Podsole\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
        { text: 'Kh oder Ks vorhanden', next: 'typ_PP' },
      ],
    },
    ...
    typ_PP: {
      id: 'typ_PP',
      question: 'Ergebnis',
      result: { title: 'Typ PP – Podsol', description: 'Kh oder Ks vorhanden.' },
    },

    // ── Y ──────────────────────────────────────────────────────────
    result_Y: {
      id: 'result_Y',
      question: 'Klasse Y – Aerobe Kultisole\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
    ...
    typ_YK: {
      id: 'typ_YK',
      question: 'Ergebnis',
      result: { title: 'Typ YK – Kolluvisol', description: 'Dj bis ≥ 4 dm u. MOF reichend.' },
    },
    typ_YD: {
      id: 'typ_YD',
      question: 'Ergebnis',
      result: { title: 'Typ YD – Deposol', description: 'Dt bis ≥ 4 dm u. MOF reichend.' },
    },
    typ_YE: {
      id: 'typ_YE',
      question: 'Ergebnis',
      result: { title: 'Typ YE – Plaggenesch', description: 'De bis ≥ 4 dm u. MOF reichend.' },
    },
    typ_YO: {
      id: 'typ_YO',
      question: 'Ergebnis',
      result: { title: 'Typ YO – Hortisol', description: 'Dx bis ≥ 4 dm u. MOF reichend.' },
    },
    typ_YY: {
      id: 'typ_YY',
      question: 'Ergebnis',
      result: { title: 'Typ YY – Rigosol', description: 'R.. bis ≥ 4 dm u. MOF reichend.' },
    },

    // ── S ──────────────────────────────────────────────────────────
    result_S: {
      id: 'result_S',
      question: 'Klasse S – Stauwasserböden\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
    ...
    typ_SS: {
      id: 'typ_SS',
      question: 'Ergebnis',
      result: { title: 'Typ SS – Pseudogley', description: 'Sw oder Sd < 4 dm u. GOF beginnend.' },
    },
    typ_SH: {
      id: 'typ_SH',
      question: 'Ergebnis',
      result: { title: 'Typ SH – Haftpseudogley', description: 'Sg < 4 dm u. GOF beginnend.' },
    },
    typ_SG: {
      id: 'typ_SG',
      question: 'Ergebnis',
      result: { title: 'Typ SG – Stagnogley', description: 'Srw < 4 dm u. GOF beginnend.' },
    },

    // ── Q ──────────────────────────────────────────────────────────
    result_Q: {
      id: 'result_Q',
      question: 'Klasse Q – Rheosole\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
        { text: 'Vf oder Vf-A.. < 3 dm u. MOF beginnend und bis ≥ 4 dm reichend', next: 'typ_QO' },
        { text: 'Vc oder Vc-A.. < 3 dm u. MOF beginnend und bis ≥ 4 dm reichend', next: 'typ_QC' },
      ],
    },
    ...
    typ_QO: {
      id: 'typ_QO',
      question: 'Ergebnis',
      result: { title: 'Typ QO – Ockerrheosol', description: 'Vf oder Vf-A.. < 3 dm u. MOF beginnend und bis ≥ 4 dm reichend.' },
    },
    typ_QC: {
      id: 'typ_QC',
      question: 'Ergebnis',
      result: { title: 'Typ QC – Kalkreosol', description: 'Vc oder Vc-A.. < 3 dm u. MOF beginnend und bis ≥ 4 dm reichend.' },
    },

    // ── A ──────────────────────────────────────────────────────────
    result_A: {
      id: 'result_A',
      question: 'Klasse A – Auenböden\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
    ...
    typ_AQ: {
      id: 'typ_AQ',
      question: 'Ergebnis',
      result: { title: 'Typ AQ – Paternia', description: 'Amh, Amu oder Amx über iCv.' },
    },
    typ_AZ: {
      id: 'typ_AZ',
      question: 'Ergebnis',
      result: { title: 'Typ AZ – Carbonatpaternia', description: 'Amh oder Amx über elCv oder clCv.' },
    },
    typ_AT: {
      id: 'typ_AT',
      question: 'Ergebnis',
      result: { title: 'Typ AT – Tschernitza', description: 'Amx bis ≥ 4 dm u. MOF reichend.' },
    },
    typ_AB: {
      id: 'typ_AB',
      question: 'Ergebnis',
      result: { title: 'Typ AB – Vega', description: 'Am.. über Mm, bis ≥ 4 dm u. MOF reichend.' },
    },

    // ── G ──────────────────────────────────────────────────────────
    result_G: {
      id: 'result_G',
      question: 'Klasse G – Gleye\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
        { text: 'Go < 4 dm u. GOF beginnend und Gr ≥ 4 dm u. GOF beginnend', next: 'typ_GG' },
        { text: 'tGo < 4 dm u. GOF beginnend und tGr ≥ 4 dm u. GOF beginnend', next: 'typ_GK' },
    ...
    typ_GG: {
      id: 'typ_GG',
      question: 'Ergebnis',
      result: { title: 'Typ GG – Gley', description: 'Go < 4 dm u. GOF beginnend und Gr ≥ 4 dm u. GOF beginnend.' },
    },
    typ_GK: {
      id: 'typ_GK',
      question: 'Ergebnis',
      result: { title: 'Typ GK – Marschgley', description: 'tGo < 4 dm u. GOF beginnend und tGr ≥ 4 dm u. GOF beginnend.' },
    },
    typ_GN: {
      id: 'typ_GN',
      question: 'Ergebnis',
      result: { title: 'Typ GN – Nassgley', description: 'Gr < 4 dm u. GOF beginnend.' },
    },

    // ── Ü ──────────────────────────────────────────────────────────
    result_Ue: {
      id: 'result_Ue',
      question: 'Klasse Ü – Strandböden\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
        { text: '..ICq oder ..Gqo an MOF beginnend', next: 'typ_UeA' },
      ],
    },
    ...
    typ_UeA: {
      id: 'typ_UeA',
      question: 'Ergebnis',
      result: { title: 'Typ ÜA – Strand', description: '..ICq oder ..Gqo an MOF beginnend.' },
    },

    // ── I ──────────────────────────────────────────────────────────
    result_I: {
      id: 'result_I',
      question: 'Klasse I – Semisubhydrische Böden\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
    ...
    typ_IA: {
      id: 'typ_IA',
      question: 'Ergebnis',
      result: { title: 'Typ IA – Nasstrand', description: 'Fqwo an MOF beginnend.' },
    },
    typ_IW: {
      id: 'typ_IW',
      question: 'Ergebnis',
    ...
    result_J: {
      id: 'result_J',
      question: 'Klasse J – Subhydrische Mineralböden\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
    ...
    typ_JP: {
      id: 'typ_JP',
      question: 'Ergebnis',
      result: { title: 'Typ JP – Protopedon', description: 'Fi oder Fw an MOF beginnend.' },
    },
    typ_JG: {
      id: 'typ_JG',
      question: 'Ergebnis',
      result: { title: 'Typ JG – Minerogyttja', description: 'Fo an MOF beginnend.' },
    },
    typ_JS: {
      id: 'typ_JS',
      question: 'Ergebnis',
      result: { title: 'Typ JS – Minerosapropel', description: 'Fr an MOF beginnend.' },
    },

    // ── X ──────────────────────────────────────────────────────────
    result_X: {
      id: 'result_X',
      question: 'Klasse X – Reduktosole\nWelche diagnostischen Horizonte sind vorhanden?',
      options: [
        { text: 'Y.. < 4 dm u. MOF beginnend', next: 'typ_XX' },
      ],
    },
    ...
    typ_XX: {
      id: 'typ_XX',
      question: 'Ergebnis',
      result: { title: 'Typ XX – Reduktosol', description: 'Y.. < 4 dm u. MOF beginnend.' },
    },
  },
};
